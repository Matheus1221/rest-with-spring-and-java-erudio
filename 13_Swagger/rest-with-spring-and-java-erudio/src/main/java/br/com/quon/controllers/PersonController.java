...
public class PersonController {
	...
	@Operation(summary = "adds a new Person",
		description = "adds a new Person by passing in a Json, XML or YML representations.",
		tags = {"People"}, 
		responses = {
			   @ApiResponse(description = "Success", responseCode ="200",
					   content =   @Content(schema = @Schema (implementation = PersonVO.class))
	...
	description = "updates a Person by passing in a Json, XML or YML representations.",
	tags = {"People"}, 
	responses = {
	...
	@DeleteMapping("/{id}")
	@Operation(summary = "Exclude a Person",
	description = "updates a Person by passing in a Json, XML or YML representations.",
	tags = {"People"}, 
	responses = {
		   @ApiResponse(description = "No Content", responseCode ="204",  content =   @Content),
